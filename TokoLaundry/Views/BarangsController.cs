...
namespace TokoLaundry.Views
{
    public class BarangsController : Controller
    {
        ...
        public BarangsController(TokoLaundryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdBarang,NamaBarang,HargaBarang,JenisBarang")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBarang,NamaBarang,HargaBarang,JenisBarang")] Barang barang)
        {
